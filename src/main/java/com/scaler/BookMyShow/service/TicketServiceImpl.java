...
public class TicketServiceImpl implements TicketService {
    ...
    @Override
    @Transactional(isolation = Isolation.SERIALIZABLE) // default isolation level for my sql is "Repeatable Read"
    public Ticket bookTicket(Long userId, List<Long> showSeatIds, Long showId) {
        User bookedByUser = (User) userRepository.findById(userId).get();
